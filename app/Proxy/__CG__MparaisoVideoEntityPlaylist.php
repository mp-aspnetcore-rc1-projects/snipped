 ...
 */
class Playlist extends \Mparaiso\Video\Entity\Playlist implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function removePlaylistVideo(\Mparaiso\Video\Entity\PlaylistVideo $playlistVideo)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'created', 'updated', 'playlistVideos');
    }
